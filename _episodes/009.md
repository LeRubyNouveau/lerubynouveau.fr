...
discoveries:
  ...
  soveran:
    picks:
      - title: qtest
        link: https://www.qasymphony.com/software-testing-tools/qtest-manager/test-case-management/
...
Michel: Oui. C'est un outil de test que j'utilise depuis 7 ans qui s'appelle Qtest. Avec Qtest chaque fichier de test est exécuté dans un processus bifurqué. On dit comme ça ? Forked ?
